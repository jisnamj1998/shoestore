...
class Product(models.Model):
    ...
    size_object=models.ManyToManyField(Size,null=True,blank=True)

    season_object=models.ManyToManyField(Season,null=True,blank=True)
    ...
    tag_object=models.ManyToManyField(Tag,null=True,blank=True)
